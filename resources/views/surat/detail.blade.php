        ...
        <div class="card">
          <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered">
              ...
              <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#previewP">Preview PPT</button>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade" id="previewP">
                <h5 class="card-title">Preview PPT</h5>
                <iframe src="{{ asset('upload/ppt/'.date('Y', strtotime($data->tanggal)).'/'.date('m', strtotime($data->tanggal)).'/'.$data->file_ppt) }}" width="100%" height="450px"></iframe>
              </div>
              <div class="tab-pane fade profile-edit pt-3" id="edit">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    ...
                    <div class="pt-2">
                      <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#upload_ppt">Ganti Presentasi</a>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-md-8 col-lg-9">
                      ...
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="gridRadios2">
                          {{ $data->ditujukan == 0 ? 'Ekternal General' : 'Eksternal Customer'}}
                        </label>
                      </div>
                    </div>
                  </div>
...
<div class="modal fade" id="upload_ppt" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form action="{{ url($button->formEtc($title)).'/ganti_surat' }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="hidden" name="jenis" value="ppt" class="form-control" required>
            <input name="id" type="hidden" value="{{ $data->id }}">
          </div>
        </div>
        <div class="modal-footer">
