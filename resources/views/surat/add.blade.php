  ...
  <div class="card card-primary">
    ...
    <form action="{{ url($button->formAdd($title)) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <div class="col-md-12 col-lg-12">
            <select name="status_se" class="form-select @error('status_se') is-invalid @enderror" aria-label="Default select example">
              ...
              <option {{ old('status_se') == '1' ? 'selected' : '' }} value="1">External Customer</option>
              @endif
            </select>
            @error('status_se')
            <div class="invalid-feedback">
        ...
        <div class="form-group">
          <label class="col-md-4 col-lg-3 col-form-label">Upload PPT</label>
          <div class="col-md-12 col-lg-12">
            <input name="file_ppt" type="file" accept=".pdf" class="form-control @error('file_ppt') is-invalid @enderror" id="file_ppt" value="{{ old('file_ppt') }}" onchange="return presentasiValidation()">
            @error('file_ppt')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
